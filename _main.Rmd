...
<!--chapter:end:02-concepts.Rmd-->

---
title: "Verständnisse und Konzepte Nachhaltiger Entwicklung"
author: "Christoph Bader"
date: "`r Sys.Date()`"
bibliography: book.bib
biblio-style: apalike
...
<!--chapter:end:03-handlungsfelder.Rmd-->
...
For example, we are using the **bookdown** package (check out the last code chunk in index.Rmd to see how this citation key was added) in this sample book, which was built on top of R Markdown and **knitr** [@xie2015] (this citation was added manually in an external file book.bib). 
